...
export function Dashboard({ camps, activeCampId, plans, onSelectPlan, onSetViewMode }: DashboardProps) {
 ...
 return [
 { label: "一收 / 1st Collection", days: calculateDays(activeCamp.meeting1StartDate), color: "bg-orange-500" },
 { label: "二收 / 2nd Collection", days: calculateDays(activeCamp.meeting2StartDate), color: "bg-amber-500" },
 { label: "三收 / 3rd Collection", days: calculateDays(activeCamp.meeting3StartDate), color: "bg-yellow-500" },
 ...
 <div className="absolute top-10 right-10 w-32 h-32 bg-white/10 rounded-full blur-2xl animate-float pointer-events-none shadow-[0_8px_30px_rgba(140,120,100,0.05)]" />
 <div className="absolute bottom-0 left-20 w-48 h-48 bg-white/5 rounded-full blur-3xl pointer-events-none shadow-[0_8px_30px_rgba(140,120,100,0.05)]" style={{ animationDelay: '2s' }} />
 ...
 className="bg-white text-primary hover:bg-white/90 h-14 px-8 rounded-2xl font-bold text-xs uppercase tracking-widest shadow-black/10 group/btn transition-all btn-shimmer btn-press cursor-pointer shadow-[0_8px_30px_rgba(140,120,100,0.05)]"
 >
 開始編寫 / Start Planning
 ...
 variant="outline" 
 className="bg-white/10  text-white hover:bg-white/20 h-14 px-8 rounded-2xl font-bold text-xs uppercase tracking-widest backdrop-blur-md btn-press cursor-pointer shadow-[0_8px_30px_rgba(140,120,100,0.05)]"
 >
 行政中心 / Admin Center
 </Button>
 </div>
 ...
 <div className={cn(
 "absolute left-0 w-4 h-4 rounded-full   shadow-md z-10 transition-transform group-hover:scale-125",
 e.color
 )} />
 ...
 className="flex items-center justify-between p-4 rounded-xl bg-secondary/50 dark:bg-secondary hover:bg-secondary dark:hover:bg-secondary/80 border-none hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 cursor-pointer group"
 >
