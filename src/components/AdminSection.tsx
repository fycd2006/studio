...
import { Clock, Table as TableIcon, Plus, ShieldCheck, Lock, Unlock, Calendar, Undo2, Redo2, Package2 } from "lucide-react";
            ...
            <TabsContent value="props" className="m-0 data-[state=active]:flex flex-col h-full overflow-hidden bg-slate-50/50">
              ...
              <div className="flex-1 overflow-y-auto p-4 md:p-8">
                <div className="max-w-6xl mx-auto space-y-8 pb-32">
                  <div className={cn("transition-opacity duration-300", isLocked ? "opacity-60 pointer-events-none" : "opacity-100")}>
                    {!isLocked && (
