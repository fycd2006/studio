  ...
  return (
    <div className="w-full flex flex-col items-center py-6 space-y-10 transition-colors duration-300">
      <div className="w-full max-w-5xl flex flex-col space-y-10">
        ...
        <div className={cn(
          "w-full p-8 rounded-[2.5rem] border border-stone-200 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl shadow-stone-200/20 dark:shadow-none transition-all duration-500",
          ...
          <Button 
            ...
            className={cn(
              ...
              audioUnlocked 
                ? "border-stone-200 dark:border-white/10 text-stone-600 dark:text-slate-400 bg-white dark:bg-slate-800" 
                : "bg-stone-900 dark:bg-amber-400 text-white dark:text-slate-900 hover:opacity-90 shadow-xl"
            )}
          >
        ...
        {!isLocked && (
          <Card className="w-full p-6 md:p-10 rounded-[3rem] border border-stone-200 dark:border-white/5 shadow-xl shadow-stone-200/20 dark:shadow-none bg-white dark:bg-slate-800/50 flex flex-col space-y-8 md:space-y-10 transition-colors">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-4">
              <div className="flex items-center gap-5">
                <div className="p-4 bg-stone-100 dark:bg-white/5 rounded-2xl border border-stone-200 dark:border-white/10">
                  <ShieldCheck className="h-7 w-7 text-stone-600 dark:text-slate-400" />
                </div>
                <div>
                  <h3 className="font-headline font-bold text-stone-900 dark:text-white tracking-tight text-base uppercase">{t('COMMAND_CENTER')}</h3>
              ...
              <div className="flex flex-col md:items-end">
                ...
                <span className="text-2xl font-headline font-bold text-stone-900 dark:text-white mt-1">
                    ...
                    {[ 
                      ...
                      <div key={i} className="relative group">
                        <Input 
                          ...
                          className="h-14 rounded-2xl border-stone-200 dark:border-white/10 bg-stone-50 dark:bg-slate-900 font-bold text-center text-lg focus:ring-2 focus:ring-amber-500/20 text-stone-900 dark:text-white w-full" 
                        />
                        <span className="absolute -top-3 right-3 px-2 bg-white dark:bg-slate-800 text-[9px] font-bold text-stone-400 dark:text-slate-500 border border-stone-200 dark:border-white/10 rounded-md uppercase shadow-sm">{item.label}</span>
                      </div>
                    ))}
                  </div>
                  <Button onClick={updateDuration} className="w-full md:w-auto h-14 px-10 rounded-2xl font-bold text-[11px] bg-stone-900 dark:bg-white text-white dark:text-stone-900 uppercase tracking-widest shrink-0 hover:opacity-90 transition-all active:scale-95 shadow-lg">{t('APPLY')}</Button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                <Button 
                  ...
                  className={cn(
                    ...
                    timer.isRunning ? "bg-rose-500 hover:bg-rose-600 text-white" : "bg-stone-900 dark:bg-amber-400 text-white dark:text-slate-900 hover:opacity-90"
                  )}
                >
                ...
                <Button 
                  variant="outline" 
                  className="h-16 rounded-[1.5rem] font-bold text-xs gap-3 border border-stone-200 dark:border-white/10 uppercase tracking-[0.2em] text-stone-600 dark:text-slate-400 hover:bg-stone-50 dark:hover:bg-white/5 transition-all" 
                  onClick={resetTimer}
                >
        ...
        <Card className="w-full rounded-[2.5rem] md:rounded-[4rem] border-none shadow-2xl bg-stone-950 text-white flex flex-col items-center justify-between p-6 md:p-12 lg:p-16 min-h-[450px] relative overflow-hidden transition-all duration-700">
          ...
          <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-6 mb-8 relative z-10">
            <div className="flex items-center gap-4 w-full sm:w-auto overflow-hidden">
              <div className="p-3 bg-white/5 rounded-xl backdrop-blur-md shrink-0 border border-white/10">
            ...
            <Button 
              ...
              variant="outline"
              className="w-full sm:w-auto bg-white/5 border-white/10 text-white hover:bg-white/10 hover:text-white rounded-xl h-12 px-6 font-bold text-[10px] uppercase tracking-widest transition-all shrink-0"
            >
