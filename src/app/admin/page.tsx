...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen relative bg-stone-50 dark:bg-[hsl(var(--bar-theme))] text-stone-900 dark:text-slate-50 transition-colors font-sans selection:bg-orange-200 dark:selection:bg-amber-500/30">
      <AdminSection
        tables={tables}
