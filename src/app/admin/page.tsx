...
export default function AdminPage() {
  ...
  return (
    <div className="h-full relative overflow-y-auto bg-stone-50 dark:bg-slate-900 text-stone-900 dark:text-slate-50 transition-colors font-sans selection:bg-orange-200 dark:selection:bg-amber-500/30">
      <AdminSection
        tables={tables}
