...
export default function AdminPage() {
  ...
  return (
    <div className="h-[100dvh] relative bg-stone-50 dark:bg-[hsl(var(--bar-theme))] text-stone-900 dark:text-slate-50 transition-colors font-sans selection:bg-orange-200 dark:selection:bg-amber-500/30 overflow-hidden">
      <AdminSection
        tables={tables}
