...
export default function HistoryOverview() {
 ...
 <h1 className="text-3xl md:text-4xl font-black tracking-tight text-[#2C2A28] dark:text-white flex items-center gap-3">
 ...
 <Badge className={cn("px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider border-none", plan.category === "activity" ? "bg-blue-50/80 text-blue-600  dark:bg-blue-900/20 dark:text-blue-400 dark:" : "bg-emerald-50/80 text-emerald-600  dark:bg-emerald-900/20 dark:text-emerald-400 dark:")}>
